...
void displayWeatherAndTime() {
    ...
    do {
        ...
        DrawBattery(display.width() - 60, 5);
        ...
        int rectHeight = 65;  // Height of each rectangle
        int rectWidth = display.width() / 3;  // Divide the width equally into three parts

       // Left rectangle for temperature and humidity
        display.drawRect(0, 30, rectWidth, rectHeight, GxEPD_BLACK);
        ...
        // Middle rectangle for the weather icon
        display.drawRect(rectWidth, 30, rectWidth, rectHeight, GxEPD_BLACK);
        int iconX = rectWidth + (rectWidth / 2) - 20;  // Center the icon horizontally
        int iconY = 45;  // Adjust the vertical position
        DisplayWXicon(iconX, iconY, String(iconCode));

        // Right rectangle for the weather condition
        display.drawRect(2 * rectWidth, 30, rectWidth, rectHeight, GxEPD_BLACK);
        display.setFont(&FreeMono12pt7b);
        int conditionX = 2 * rectWidth + 10;
        int conditionY = 55;
        display.setCursor(conditionX, conditionY);
        display.print(weather ? weather : "N/A");
